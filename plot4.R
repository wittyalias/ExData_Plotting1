...
png(filename = "plot4.png")
        ...
        # Upper left plot, basically the same as plot2
        ...
        # Lower left plot, basically the same as plot3
        ...
        legend("topright", col = c("black","blue","red"), legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), bty="n")
